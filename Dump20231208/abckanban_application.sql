...
CREATE TABLE `application` (
  ...
  `App_permit_Open` longtext,
  `App_permit_toDoList` longtext,
  `App_permit_Doing` longtext,
  `App_permit_Done` longtext,
  `App_permit_Create` longtext,
...
-- Dump completed on 2023-12-08 17:41:50
